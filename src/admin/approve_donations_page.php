...
$sql_terms = "SELECT dt.term_id, dt.created_at, dt.responsible_donation, dt.institution_name, u.username AS registered_by_username
...
if ($result_terms) {
    ...
    $error_message = "Erro ao carregar os termos de doação pendentes. Tente novamente mais tarde.";
}
